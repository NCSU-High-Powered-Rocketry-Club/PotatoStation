...
def style_gui_from_file(styleConfigPath: str):
    ...
    style.window_menu_button_position = getDirection(data["windowMenuButtonPosition"])
    ...
    colorData = {color: fixColorRange(colorData[color], 255.0) for color in colorData}
    ...
    style.set_color_(imgui.Col_.frame_bg_hovered, colorData["FrameBgHovered"])
    style.set_color_(imgui.Col_.frame_bg_active, colorData["FrameBgActive"])
    style.set_color_(imgui.Col_.title_bg, colorData["TitleBg"])
    style.set_color_(imgui.Col_.title_bg_active, colorData["TitleBgActive"])
    style.set_color_(imgui.Col_.title_bg_collapsed, colorData["TitleBgCollapsed"])
    style.set_color_(imgui.Col_.menu_bar_bg, colorData["MenuBarBg"])
    style.set_color_(imgui.Col_.scrollbar_bg, colorData["ScrollbarBg"])
    style.set_color_(imgui.Col_.scrollbar_grab, colorData["ScrollbarGrab"])
    style.set_color_(
        imgui.Col_.scrollbar_grab_hovered, colorData["ScrollbarGrabHovered"]
    )
    style.set_color_(imgui.Col_.scrollbar_grab_active, colorData["ScrollbarGrabActive"])
    ...
    style.set_color_(imgui.Col_.separator_hovered, colorData["SeparatorHovered"])
    style.set_color_(imgui.Col_.separator_active, colorData["SeparatorActive"])
    style.set_color_(imgui.Col_.resize_grip, colorData["ResizeGrip"])
    style.set_color_(imgui.Col_.resize_grip_hovered, colorData["ResizeGripHovered"])
    style.set_color_(imgui.Col_.resize_grip_active, colorData["ResizeGripActive"])
    ...
    style.set_color_(imgui.Col_.tab_unfocused_active, colorData["TabUnfocusedActive"])
    style.set_color_(imgui.Col_.plot_lines, colorData["PlotLines"])
    style.set_color_(imgui.Col_.plot_lines_hovered, colorData["PlotLinesHovered"])
    style.set_color_(imgui.Col_.plot_histogram, colorData["PlotHistogram"])
    style.set_color_(
        imgui.Col_.plot_histogram_hovered, colorData["PlotHistogramHovered"]
    )
    style.set_color_(imgui.Col_.table_header_bg, colorData["TableHeaderBg"])
    style.set_color_(imgui.Col_.table_border_strong, colorData["TableBorderStrong"])
    style.set_color_(imgui.Col_.table_border_light, colorData["TableBorderLight"])
    style.set_color_(imgui.Col_.table_row_bg, colorData["TableRowBg"])
    style.set_color_(imgui.Col_.table_row_bg_alt, colorData["TableRowBgAlt"])
    style.set_color_(imgui.Col_.text_selected_bg, colorData["TextSelectedBg"])
    ...
    style.set_color_(
        imgui.Col_.nav_windowing_highlight, colorData["NavWindowingHighlight"]
    )
    style.set_color_(imgui.Col_.nav_windowing_dim_bg, colorData["NavWindowingDimBg"])
    style.set_color_(imgui.Col_.modal_window_dim_bg, colorData["ModalWindowDimBg"])
